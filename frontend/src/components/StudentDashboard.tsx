...
export default function StudentDashboard() {
  ...
  const stats = [
    ...
    { label: 'Applications', value: jobStats.applied.toString(), icon: Send, color: 'text-blue-600', path: '/saved-jobs' },
  ...
  return (
    <div className="space-y-6 font-sans pb-10 max-w-7xl mx-auto">
      ...
      <div className="bg-white border border-slate-100 rounded-3xl p-6 md:p-8 shadow-sm relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-center gap-6 relative z-10">
          <div className="relative shrink-0">
            ...
            <div className="absolute -bottom-2 -right-2 bg-emerald-500 text-white text-[10px] font-black px-2 py-1 rounded-md shadow-sm border-2 border-white">
              PRO
            </div>
          </div>
          <div className="flex-1 text-center md:text-left space-y-2">
            <div className="flex flex-col md:flex-row md:items-end gap-2 md:gap-3">
              <h1 className="text-2xl md:text-3xl font-black text-slate-900">{userName}</h1>
              <span className="text-sm font-bold text-slate-400 pb-1">{educationLevel}</span>
            </div>
            <div className="text-sm font-bold text-slate-600 flex items-center justify-center md:justify-start gap-1">
              Aspiring Engineer <div className="w-1.5 h-1.5 rounded-full bg-blue-500 ml-1"></div>
            </div>
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 pt-1">
              <span className="px-3 py-1 bg-slate-100 text-slate-600 text-[10px] font-bold rounded-lg">Engineering</span>
              <span className="px-3 py-1 bg-slate-100 text-slate-600 text-[10px] font-bold rounded-lg">AI</span>
              <span className="px-3 py-1 bg-slate-100 text-slate-600 text-[10px] font-bold rounded-lg">Tech</span>
            </div>
          </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {stats.map((stat, idx) => (
          <div key={idx} onClick={() => navigate(stat.path)} className="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm flex items-center justify-between group hover:border-blue-200 transition-colors cursor-pointer">
            ...
            <button className="text-[10px] font-bold text-slate-400 group-hover:text-blue-600 transition-colors">VIEW &rarr;</button>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="w-full bg-slate-100 h-1.5 rounded-full"><div className="bg-indigo-500 h-full rounded-full" style={{ width: '75%' }}></div></div>
                </div>
                <div>
                  <div className="flex justify-between text-xs font-bold text-slate-600 mb-1.5">
                  ...
                  <div className="w-full bg-slate-100 h-1.5 rounded-full"><div className="bg-indigo-500 h-full rounded-full" style={{ width: '40%' }}></div></div>
                </div>
                <div className="pt-2">
            ...
            <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-slate-500 mt-1">Tested on 12 Aug 2026</div>
                </div>
              </div>
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 divide-y md:divide-y-0 md:divide-x divide-slate-800">
              ...
              <div className="pt-6 md:pt-0 md:pl-8">
                ...
                <div className="space-y-2 mt-4">
                  ...
                  <div className="flex items-center gap-3 text-xs text-slate-300">
                    <CheckCircle className="w-3.5 h-3.5 text-slate-500" /> Clear JEE Mains
                  </div>
                  <div className="flex items-center gap-3 text-xs text-slate-300">
                    <CheckCircle className="w-3.5 h-3.5 text-slate-500" /> Enroll in Top NIT/IIT
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              ...
              <button className="text-xs font-bold text-blue-600 hover:underline">View Job Explorer</button>
            </div>
                ...
                <div key={idx} className="flex items-center justify-between p-4 bg-slate-50 rounded-xl border border-slate-100">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] font-semibold text-slate-500 mt-0.5">{job.company} • {job.location}</div>
                    </div>
                  </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-sm font-bold text-slate-900">JEE Mains Registration</div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-sm font-bold text-slate-800">VITEEE Mock Test</div>
          ...
          <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl p-6 text-white shadow-lg">
            <div className="bg-white/20 w-fit p-2.5 rounded-xl mb-4 backdrop-blur-sm border border-white/20">
              ...
              {[
                ...
                <div key={idx} className="flex items-center gap-3 p-3 bg-slate-50 rounded-xl border border-slate-100">
                  ...
                  <div>
                    ...
                    <div className="text-[9px] font-bold text-slate-400 mt-0.5 uppercase tracking-wider">{item.type}</div>
                  </div>
                </div>
              ))}
            </div>
