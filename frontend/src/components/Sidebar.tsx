...
import { 
  ...
  Users, Award, Brain, Settings, Bell, Heart, CheckCircle, GraduationCap, Briefcase, Bookmark, ArrowRight, User, FileText, Network, Split, ShieldAlert, BadgeCheck, GitMerge, Beaker
} from 'lucide-react';
